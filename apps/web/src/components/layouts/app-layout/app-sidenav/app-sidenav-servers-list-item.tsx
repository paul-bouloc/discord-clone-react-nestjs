...
export const AppSidenavServersListItem = ({
  ...
  return (
    <div className="group relative flex h-10 w-full cursor-pointer justify-center">
      {/* ETA MARK */}
      <div className="absolute top-0 left-0 w-1.5">
        {/* Marker sélectionné - pleine hauteur */}
        {isSelected && <div className="bg-gray-230 flex h-10 items-center justify-center rounded-r-full"></div>}
      ...
      <div
        className={cn(
          'flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-lg transition-all duration-200',
